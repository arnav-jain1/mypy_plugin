...
def minibatch(X : np.ndarray, batchsize=256, shuffle=True):
    """
...
def pad1D(X : np.ndarray, pad, kernel_width=None, stride=None, dilation=0) -> Tuple[np.ndarray[Tuple[int, int, int]], Any]:
    """
...
def pad2D(X : np.ndarray, pad, kernel_shape=None, stride=None, dilation=0):
    """
...
def dilate(X : np.ndarray[Tuple[int, int, int, int]], d):
    """
...
# def calc_conv_out_dims(X_shape : Union[Tuple[int, int, int], Tuple[int, int, int, int]], W_shape, stride=1, pad=0, dilation=0):
#     """
