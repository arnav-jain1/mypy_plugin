...
from rl_models.tiles.tiles3 import tiles, IHT
...
def tile_state_space(
    ...
    env_stats,
    n_tilings : int,
    obs_max: Union[np.ndarray[Tuple[int]], float, None] =None,
    obs_min: Union[np.ndarray[Tuple[int]], float, None] =None,
    state_action=False,
    grid_size : np.ndarray[Tuple[Literal[2]]]=np.array((4, 4)),
):
    """
