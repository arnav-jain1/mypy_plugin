...
def _last_dims(X: np.ndarray[tuple[Any, int]], t, ndims=2):
...
def _loglikelihoods(
    observation_matrices: np.ndarray[tuple[Any, int, int]],
    observation_offsets: np.ndarray[tuple[Any, int]],
    observation_covariance: np.ndarray[tuple[int, int]],
    predicted_state_means: np.ndarray[tuple[int, int]],
    predicted_state_covariances: np.ndarray[tuple[int, int, int]],
    observations: np.ndarray[tuple[int]],
